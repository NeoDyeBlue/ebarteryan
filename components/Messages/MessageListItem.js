...
export default function MessageListItem({
  ...
  return (
    <li
      className="relative flex cursor-pointer items-center gap-2 rounded-[10px] before:absolute before:left-1/2
    before:-z-10 before:h-full before:w-[calc(100%+5%)] before:translate-x-[-50%]
    before:rounded-[10px] before:bg-blue-100 before:bg-transparent hover:before:bg-gray-100/30"
    >
